            ...
            child: ClipRRect(
              ...
              child: NavigationBar(
                ...
                destinations: const [
                  ...
                  NavigationDestination(
                    icon: Icon(Symbols.photo_library, size: 22),
                    selectedIcon: Icon(Symbols.photo_library, size: 22),
                    label: 'Albums',
                    tooltip: 'Your custom photo albums',
                  ),
                ],
              ),
            ),
          ...
          NavigationRail(
            ...
            destinations: const [
              ...
              NavigationRailDestination(
                ...
                selectedIcon: Icon(Symbols.photo_library),
                label: Text('Albums'),
              ),
            ],
          ),
