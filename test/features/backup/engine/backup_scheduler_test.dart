  ...
  group('BackupScheduler', () {
    group('evaluate', () {
      ...
      test('blocks backup when wifi required but not connected', () {
        ...
        const environment = BackupEnvironment(isWifiConnected: false);
      ...
      test('blocks backup when charging required but not charging', () {
        ...
        const environment = BackupEnvironment(isCharging: false);
      ...
      test('blocks backup when battery too low', () {
        const settings = BackupSettings();
        const environment = BackupEnvironment(batteryLevel: 15);
