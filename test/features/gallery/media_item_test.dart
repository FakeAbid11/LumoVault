...
void main() {
  group('MediaItem', () {
    ...
    test('hasLocation reflects presence of both coordinates', () {
      MediaItem base({double? latitude, double? longitude}) => MediaItem(
        localId: '1',
        fileHash: 'hash1',
        filePath: '/path/test.jpg',
        fileName: 'test.jpg',
      ...
      expect(base(latitude: 37.7, longitude: -122.4).hasLocation, true);
      expect(base().hasLocation, false);
      expect(base(latitude: 37.7).hasLocation, false);
      expect(base(longitude: -122.4).hasLocation, false);
    });
  });
}
