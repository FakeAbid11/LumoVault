...
final faceAnalysisProgressProvider =
    StateProvider<(int, int, int)>((ref) => (0, 0, 0));

/// All face groups, refreshed whenever a mutation occurs.
final faceGroupsProvider =
    FutureProvider.autoDispose<List<FaceGroup>>((ref) async {
...
final groupFacesProvider =
    FutureProvider.autoDispose.family<List<DetectedFaceItem>, int>(
  (ref, groupId) async {
    final repo = ref.watch(faceRepositoryProvider);
