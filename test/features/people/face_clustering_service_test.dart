...
void main() {
  ...
  group('cosineSimilarity', () {
    ...
    test('refuses mismatched-length vectors instead of prefix-comparing', () {
      // v20: a dimension mismatch means different embedding models/spaces.
      // The old shared-prefix score produced plausible-looking similarities
      // between incomparable vectors and merged different people into one
      // group; now mismatches must be refused outright.
      expect(service.cosineSimilarity(const [1.0, 0.0], _embedding(0)), 0.0);
      expect(service.cosineSimilarity(_embedding(0), const [1.0, 0.0]), 0.0);
    });
  });
