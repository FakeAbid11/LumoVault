...
/// (Canonical copy lives in brand_settings.dart so the wizard, banner and
/// card all surface the same text.)
const String kOpenSettingsFallbackHint = kSettingsLaunchFallbackHint;
