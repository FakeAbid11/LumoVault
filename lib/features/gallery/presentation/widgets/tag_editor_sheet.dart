...
class TagEditorSheet extends ConsumerStatefulWidget {
  const TagEditorSheet({required this.mediaId, this.asset, super.key});

  final String mediaId;

  /// The device asset, so tagging a photo that has never been scanned still
  /// persists instead of silently no-opping — see [GalleryRepository.setTags].
...
class _TagEditorSheetState extends ConsumerState<TagEditorSheet> {
  ...
  Future<void> _save() async {
    await ref
        .read(galleryRepositoryProvider)
        .setTags(widget.mediaId, _tags, asset: widget.asset);
