...
# --- ONNX Runtime (face detection / embeddings) ------------------------------
# The Flutter plugin bridges Dart <-> native through JNI; the Java-side
# entry points must keep their names for the native library to find them.
