...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-1075%20passing-brightgreen" alt="Tests">
</p>
...
```sh
flutter test          # 1075 tests (unit + widget)
...
- 1075 passing tests across unit and widget suites (40.5% line coverage)
