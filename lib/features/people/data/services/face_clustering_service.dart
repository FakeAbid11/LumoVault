...
/// accepted embedder (EdgeFace-XS-GAMMA since v20; the vector model tag on
/// every row is what guarantees spaces never mix). Supports adaptive
/// thresholds, centroid computation, and refinement.
class FaceClusteringService {
  ...
  double cosineSimilarity(List<double> a, List<double> b) {
    ...
    // Mismatched dimensions mean embeddings from different models/spaces
    // (192-d legacy vs 512-d, or two ONNX embedders). The old shared-prefix
    // comparison silently scored their first N dims against each other —
    // landing in the ambiguous 0.4-0.6 band and merging different people.
    // A mismatch is not "dissimilar", it is INCOMPARABLE: refuse with 0.
