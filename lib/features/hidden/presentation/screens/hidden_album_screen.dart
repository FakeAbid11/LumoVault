      ...
      body: RefreshIndicator(
        ...
        child: hidden.when(
          data: (items) => deviceAssets.when(
            ...
            // An asset-list failure must not render as "Hidden album is
            // empty" — that erased items the user knows they hid. Show the
            // shared error state with a retry instead.
