...
void main() {
  ...
  group('MetadataPartition', () {
    ...
    test('hash detects user-visible metadata edits', () {
      ...
      // An EXIF date edit flips isDateUserSet; without it in the digest the
      // "date is user-set" half of the edit never reached the channel.
      expect(
        partition([item(isDateUserSet: true)]).computeHash(),
        isNot(baseHash),
      );
    });
