...
class InlineVideoPlayer extends StatefulWidget {
  ...
  /// Reports the player's own fullscreen state to the host. The viewers keep
  /// a mirrored flag for their `PopScope.canPop`: without this callback the
  /// player's toggle never reaches the host, `canPop` stayed true, and a back
  /// press exited the app instead of leaving fullscreen.
