...
final downloadServiceProvider = Provider<DownloadService>((ref) {
  ...
  final service = TelegramDownloadService(manager: manager);
  // The service owns a broadcast progress controller and in-flight completers.
  // Without this, the controller leaked for the app's lifetime and a download
  // dropped mid-teardown left its completer hanging forever. dispose() lives
  // on the concrete type on purpose: putting it on the interface would let any
  // consumer dispose this shared service out from under the others.
