...
void main() {
  group('AppSettings', () {
    ...
    group('equality', () {
      ...
      test('settings differing only in debugMode are not equal', () {
        const a = AppSettings(debugMode: false);
        const b = AppSettings(debugMode: true);
      ...
      test('settings differing only in excludedFolders are not equal', () {
        const a = AppSettings(excludedFolders: ['a', 'b']);
        const b = AppSettings(excludedFolders: ['a', 'c']);
