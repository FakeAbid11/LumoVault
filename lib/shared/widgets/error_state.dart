    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Announce the failure as one node (icon + headline + message)
            // rather than three unrelated fragments. Retry stays outside the
            // merge so it remains an independently focusable action.
            MergeSemantics(
              child: Column(
