...
class GalleryRepository {
  ...
  Map<String, List<MediaItem>> getTimelineByDate() {
    ...
    for (final item in _mediaItems) {
      ...
      final dateKey = formatDateKey(item.createdAt);
  ...
  /// Batch restore: untrash multiple items in one pass, with a single
  /// database write and a single metadata notification.
  Future<void> restoreFromTrashBatch(List<String> localIds) async {
