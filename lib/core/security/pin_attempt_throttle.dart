...
/// [ThrottleStore] backed by [lumoSecureStorage] — see that declaration for why
/// the Android options have to be passed explicitly.
class SecureThrottleStore implements ThrottleStore {
  SecureThrottleStore({FlutterSecureStorage? storage})
    : _storage = storage ?? lumoSecureStorage;
