  ...
  void _showCancelDialog(BuildContext context, WidgetRef ref) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        // Was "You can resume it later" — cancelRestoreProvider calls
        // engine.cancelRestore() *and* progressNotifier.reset(), and the engine
        // keeps no resumable cursor, so a cancelled restore always starts over.
        // Saying so beats promising a resume that doesn't exist; restarting is
        // safe because the rebuild merges into local state instead of clearing
        // it. Pausing, which does resume, is offered separately.
        content: const Text(
          'Are you sure you want to cancel the restore? '
          'Anything already restored is kept, but a new restore starts again '
          'from the beginning.',
        ),
        actions: [
          TextButton(
