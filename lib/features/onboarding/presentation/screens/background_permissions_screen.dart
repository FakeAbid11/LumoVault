...
class _BackgroundPermissionsScreenState
  ...
  Future<void> _loadBrand() async {
    ...
    // Resolved from the platform — a hardcoded id would break under any
    // renamed/flavored build and opened the WRONG app's pages.
                      ...
                      try {
                        ...
                        if (!opened && context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text(kSettingsLaunchFallbackHint),
                            ),
                          );
                        }
                      } catch (_) {
