...
class _DuplicateTileState extends State<_DuplicateTile> {
  /// Built once per item instead of in build(), which re-issued a MediaStore
  /// lookup for every visible tile on every repaint and flashed the
  /// not-found placeholder between selection taps.
  ...
  @override
  void didUpdateWidget(_DuplicateTile oldWidget) {
