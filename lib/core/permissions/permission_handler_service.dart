...
class PermissionHandlerService implements PermissionService {
  ...
  Future<PermissionRequestResult> requestMediaPermission() async {
    ...
    // Request both photos and videos permissions. accessMediaLocation is
    // requested alongside so scans can read un-redacted GPS EXIF for the Map
    // tab; it is best-effort and does NOT gate media access, so its result is
    // deliberately excluded from the combined status below.
