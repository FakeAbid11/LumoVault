...
void main() {
  ...
  group('PinService hashing', () {
    ...
    test('verifyPin accepts the correct PIN', () async {
      ...
      expect(await service.verifyPin(pin: '135790', encoded: hash), isTrue);
    });

    test('verifyPin rejects an incorrect PIN', () async {
      final hash = service.hashPin('135790');
      expect(await service.verifyPin(pin: '135791', encoded: hash), isFalse);
    });
