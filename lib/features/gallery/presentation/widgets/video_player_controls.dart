...
class _VideoPlayerControlsState extends State<VideoPlayerControls>
  ...
  Widget build(BuildContext context) {
    ...
    // Always build the AnimatedOpacity: an early return when !visible made
    // the opacity: 0.0 branch below unreachable, so the fade-out never played
    // and the controls vanished in a single frame. IgnorePointer keeps the
    // faded-out controls from intercepting taps meant for the video.
