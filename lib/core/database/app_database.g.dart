...
class FaceRow extends DataClass implements Insertable<FaceRow> {
  ...
  /// Basename of the ONNX embedder that produced [embedding] (e.g.
  /// 'edgeface_xs_gamma_06.onnx'). Vectors from different models are NOT
  /// comparable — clustering must refuse cross-model matches. '' = legacy
  /// pre-provenance row (only possible before v20; v20 wiped those).
  final String embeddingModel;

  /// User removed this face from its person ('this is not the person');
  /// excluded faces are never re-absorbed or re-clustered.
  final bool excluded;
...
class $PeopleTable extends People with TableInfo<$PeopleTable, PersonRow> {
  ...
  static const VerificationMeta _centroidModelMeta = const VerificationMeta(
    'centroidModel',
  );
  @override
  late final GeneratedColumn<String> centroidModel = GeneratedColumn<String>(
    'centroid_model',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('centroid_model')) {
      context.handle(
        _centroidModelMeta,
        centroidModel.isAcceptableOrUnknown(
          data['centroid_model']!,
          _centroidModelMeta,
        ),
      );
  ...
  PersonRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PersonRow(
      ...
      centroidModel: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}centroid_model'],
      )!,
    );
  }
...
class PersonRow extends DataClass implements Insertable<PersonRow> {
  ...
  /// Embedder model shared by the member faces that produced
  /// [centroidEmbedding]; must equal member [Faces.embeddingModel] for
  /// absorption/merge comparisons to run at all.
  final String centroidModel;
  const PersonRow({
    required this.id,
    this.name,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['centroid_model'] = Variable<String>(centroidModel);
    return map;
  }
  ...
  PeopleCompanion toCompanion(bool nullToAbsent) {
    return PeopleCompanion(
      ...
      centroidModel: Value(centroidModel),
    );
  }
  ...
  factory PersonRow.fromJson(
    ...
    return PersonRow(
      ...
      centroidModel: serializer.fromJson<String>(json['centroidModel']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'centroidModel': serializer.toJson<String>(centroidModel),
    };
  }
  ...
  PersonRow copyWith({
    ...
    centroidModel: centroidModel ?? this.centroidModel,
  );
  PersonRow copyWithCompanion(PeopleCompanion data) {
    return PersonRow(
      ...
      centroidModel: data.centroidModel.present
          ? data.centroidModel.value
          : this.centroidModel,
    );
  }
  ...
  String toString() {
    return (StringBuffer('PersonRow(')
          ...
          ..write('centroidModel: $centroidModel')
          ..write(')'))
        .toString();
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is PersonRow &&
          ...
          other.centroidModel == this.centroidModel);
}
...
class PeopleCompanion extends UpdateCompanion<PersonRow> {
  ...
  final Value<String> centroidModel;
  const PeopleCompanion({
    ...
    this.centroidModel = const Value.absent(),
  });
  ...
  static Insertable<PersonRow> custom({
    ...
    Expression<String>? centroidModel,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
      ...
      if (centroidModel != null) 'centroid_model': centroidModel,
    });
  }
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (centroidModel.present) {
      map['centroid_model'] = Variable<String>(centroidModel.value);
    }
    return map;
  }
...
class $$PeopleTableFilterComposer
  ...
  ColumnFilters<String> get centroidModel => $composableBuilder(
    column: $table.centroidModel,
    builder: (column) => ColumnFilters(column),
  );
}
...
class $$PeopleTableOrderingComposer
  ...
  ColumnOrderings<String> get centroidModel => $composableBuilder(
    column: $table.centroidModel,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$PeopleTableAnnotationComposer
  ...
  GeneratedColumn<String> get centroidModel => $composableBuilder(
    column: $table.centroidModel,
    builder: (column) => column,
  );
}
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> centroidModel = const Value.absent(),
              }) => PeopleCompanion(
                id: id,
                name: name,
