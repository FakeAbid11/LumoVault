            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Gated on the hash existing rather than on pinLockEnabled, so
                  // a PIN is always available as a fallback when biometrics
                  // can't authenticate. submitPin verifies against pinHash
                  // alone, so nothing else needs to change.
