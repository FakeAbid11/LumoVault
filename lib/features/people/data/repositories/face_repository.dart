...
class FaceRepository {
  ...
  Future<int> clusterFaces() async {
    ...
    // v20: cohort by embedder model before clustering — average-linkage and
    // the refinement sweep must never mix vectors from different spaces, and
    // a person's centroid must be tagged with the space it lives in.
