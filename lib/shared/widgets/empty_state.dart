    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Announce the empty state as one node (icon + headline +
            // message) rather than three unrelated fragments. The action
            // stays outside the merge so its own label stays reachable.
            MergeSemantics(
              child: Column(
