...
/// Opens the real [AppDatabase] pinned to schema version 19, so this test
/// exercises ONLY the v19 step even after the app moves to v20+ (the v20
/// face wipe would otherwise run in the same migration chain).
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      // Phase 2: reopen pinned at v19 — isolates the label/embedding wipe.
      final db = _DbAtV19(NativeDatabase(dbFile));
